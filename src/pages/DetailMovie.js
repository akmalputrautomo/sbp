...
export default function PageSearch() {
  ...
  const gambarkumpul = [
    ...
    },
    {
      ...
      penjelasan:
        "Tari Kecak adalah pertunjukan seni yang unik di Bali, di mana kelompok pria duduk melingkar sambil mengucapkan 'cak-cak-cak' secara serempak. Suara ini menciptakan ritme yang menggambarkan suasana dramatis dalam kisah Ramayana, khususnya saat Hanoman dan pasukan wanaranya bertempur melawan Rahwana. Tari ini tidak menggunakan alat musik tradisional, melainkan hanya suara manusia sebagai pengiring utama. Dalam setiap pertunjukan, para penari mengenakan kain poleng (kotak-kotak hitam putih) sebagai simbol dualitas. Kecak tidak hanya menjadi hiburan, tetapi juga mencerminkan nilai-nilai spiritual dan seni yang mendalam.",
      judul: "Tari Kecak",
    ...
    },
    {
      ...
      foto: gambar4,
      Sejarah:
        "Perayaan Galungan pertama kali disebutkan dalam lontar-lontar kuno Bali yang berasal dari abad ke-10. Galungan diyakini sebagai peringatan kemenangan Dharma (kebenaran) atas Adharma (kejahatan), yang berakar dari mitologi Bali tentang pertempuran antara Dewa Indra dan Mayadenawa. Tradisi ini juga mencerminkan filosofi Tri Hita Karana, yaitu keharmonisan hubungan manusia dengan Tuhan, sesama manusia, dan alam. Dalam perkembangannya, Galungan menjadi perayaan utama umat Hindu Bali yang dilakukan dengan penuh suka cita setiap 210 hari berdasarkan kalender Pawukon.",
      penjelasan:
        "Galungan adalah perayaan penting dalam tradisi Hindu Bali yang menandai kemenangan kebaikan atas kejahatan. Ritual ini diawali dengan persiapan yang disebut Penyekeban, di mana masyarakat mulai membuat persiapan seperti memasak dan membuat penjor (hiasan bambu khas Bali). Pada hari Galungan, keluarga berkumpul untuk berdoa di pura dan memberikan sesajen kepada leluhur. Perayaan ini juga menjadi waktu bagi masyarakat Bali untuk mempererat hubungan kekeluargaan dan komunitas, sekaligus merenungkan nilai-nilai kebenaran dalam kehidupan.",
    ...
    },
    {
      ...
      penjelasan:
        "Tahun Baru Saka adalah perayaan spiritual yang dimulai dengan serangkaian ritual. Melasti adalah prosesi ke laut untuk memohon kesucian, Tawur Kesanga dilakukan sehari sebelum Nyepi untuk menyeimbangkan energi negatif dan positif, sedangkan Nyepi merupakan hari berdiam diri tanpa aktivitas duniawi. Pada hari ini, umat Hindu tidak bekerja, bepergian, atau menyalakan api sebagai bentuk refleksi. Perayaan ini berakhir dengan Ngembak Geni, yaitu hari di mana masyarakat kembali menjalani kehidupan sehari-hari dengan semangat baru.",
    ...
    },
    {
      ...
      foto: gambar6,
      Sejarah:
        "Hari Kuningan dirayakan 10 hari setelah Galungan, menandai kembalinya roh leluhur ke alam baka. Tradisi ini bermula dari mitos tentang kehadiran para leluhur yang kembali ke dunia selama Galungan untuk memberkati keturunan mereka. Hari Kuningan adalah wujud syukur kepada leluhur dan dewa atas berkah yang diberikan. Pada masa lalu, perayaan ini dilakukan dengan sederhana, tetapi seiring waktu, tradisi ini menjadi semakin kompleks dengan ditambahkannya elemen-elemen seni dan budaya khas Bali.",
      penjelasan:
        "Hari Kuningan adalah momen penting dalam siklus keagamaan Hindu Bali. Pada hari ini, umat memberikan sesajen khusus yang dihias dengan janur kuning sebagai simbol kemurnian dan kesucian. Ritual ini melibatkan doa-doa untuk memohon keselamatan dan keberkahan. Selain itu, Kuningan juga dipenuhi dengan suasana sukacita, di mana keluarga dan komunitas berkumpul untuk mempererat hubungan sosial dan spiritual.",
      judul: "Hari Kuningan",
    ...
    },
    {
      ...
      foto: gambar9,
      Sejarah:
        "Upacara Ruwatan merupakan tradisi kuno yang ditemukan dalam berbagai budaya Hindu di Nusantara, termasuk Bali dan Jawa. Dalam kepercayaan Bali, ruwatan berfungsi untuk membersihkan seseorang dari nasib buruk atau malapetaka yang disebut 'sukerta.' Tradisi ini dipercaya berasal dari mitologi Ramayana, di mana penyucian dilakukan oleh para dewa untuk melindungi manusia dari kekuatan negatif.",
      penjelasan:
        "Ruwatan adalah upacara yang bertujuan untuk menghilangkan energi negatif atau nasib buruk. Ritual ini melibatkan persembahan khusus, doa, dan pemercikan air suci. Biasanya dilakukan untuk individu dengan keadaan tertentu, seperti lahir pada hari yang dianggap kurang baik. Upacara ini juga sering dilakukan sebagai bagian dari proses penyucian spiritual dalam kehidupan sehari-hari.",
    ...
    },
    {
      ...
      foto: gambar10,
      Sejarah:
        "Tradisi Mekare-Kare berasal dari desa Tenganan Pegringsingan, sebuah desa Bali Aga yang masih mempertahankan tradisi kuno Bali. Ritual ini berakar dari keyakinan bahwa pertarungan simbolis dapat membantu menyeimbangkan energi positif dan negatif dalam masyarakat. Mekare-Kare juga merupakan penghormatan kepada Dewa Indra, dewa perang dan keberanian, sebagai bentuk ucapan terima kasih atas perlindungan yang diberikan.",
      penjelasan:
        "Mekare-Kare adalah tradisi perang-perangan menggunakan daun pandan berduri sebagai senjata. Ritual ini melibatkan pemuda desa yang saling bertarung secara simbolis untuk menguji keberanian dan kekuatan. Meskipun terlihat keras, tradisi ini sebenarnya dilakukan dengan semangat persaudaraan dan diakhiri dengan doa bersama. Mekare-Kare juga menjadi momen penting untuk mempererat hubungan sosial dan menjaga keharmonisan desa.",
    ...
    },
    {
      ...
      foto: gambar11,
      Sejarah:
        "Upacara Bali Jani bermula sebagai bentuk rasa syukur atas panen yang melimpah. Ritual ini muncul bersamaan dengan perkembangan pertanian di Bali pada abad ke-12, ketika masyarakat mulai mengadopsi sistem irigasi Subak. Tradisi ini berkembang menjadi bagian penting dari perayaan Tahun Baru Saka, mencerminkan rasa syukur dan harapan akan kesejahteraan yang berkelanjutan.",
      penjelasan:
        "Bali Jani adalah upacara yang dilakukan untuk menyambut Tahun Baru Saka sekaligus merayakan hasil panen. Ritual ini melibatkan pemberian sesajen di pura-pura, doa bersama, dan berbagai aktivitas budaya. Masyarakat percaya bahwa melalui Bali Jani, mereka dapat menjaga keharmonisan dengan alam dan mendapatkan berkah untuk masa depan.",
    ...
    },
    {
      ...
      foto: gambar12,
      Sejarah:
        "Konsep Panca Yajna telah dikenal dalam ajaran Hindu sejak ribuan tahun lalu dan diadaptasi secara lokal oleh masyarakat Bali. Panca Yajna adalah lima bentuk pengorbanan yang mencakup penghormatan kepada Tuhan, leluhur, guru, mahluk hidup lainnya, dan diri sendiri. Tradisi ini merupakan wujud harmoni yang diajarkan dalam filosofi Hindu Bali, yaitu menjaga keseimbangan antara hubungan manusia dengan Tuhan, sesama, dan alam.",
      penjelasan:
        "Panca Yajna adalah lima jenis pengorbanan suci dalam tradisi Hindu Bali. Yajna ini meliputi persembahan kepada dewa-dewa (Dewa Yajna), leluhur (Pitra Yajna), manusia lainnya (Manusa Yajna), mahluk hidup lainnya (Bhuta Yajna), dan diri sendiri (Rsi Yajna). Setiap jenis Yajna memiliki ritual khusus yang mencerminkan rasa syukur dan tanggung jawab manusia sebagai bagian dari alam semesta.",
      judul: "Panca Yajna",
    ...
    },
    {
      ...
      foto: gambar13,
      Sejarah:
        "Tradisi Omed-Omedan berasal dari Banjar Kaja Sesetan, Denpasar, yang telah dilakukan sejak abad ke-18. Tradisi ini bermula sebagai cara untuk meredakan konflik antar pemuda di desa tersebut dan berkembang menjadi simbol persatuan dan cinta kasih. Dalam sejarahnya, tradisi ini juga dipercaya memiliki kekuatan magis untuk mendatangkan keberuntungan bagi masyarakat desa.",
      penjelasan:
        "Omed-Omedan adalah tradisi unik di mana pemuda-pemudi saling menarik dan mencium satu sama lain sebagai simbol persatuan dan cinta kasih. Ritual ini dilakukan setelah Hari Raya Nyepi, diiringi doa dan persembahan. Tradisi ini tidak hanya menjadi hiburan, tetapi juga media untuk mempererat hubungan sosial di masyarakat.",
    ...
    },
    {
      ...
      foto: gambar14,
      Sejarah:
        "Pawai Ogoh-Ogoh mulai diperkenalkan pada awal abad ke-20 sebagai bagian dari Tawur Kesanga, ritual sehari sebelum Nyepi. Tradisi ini mencerminkan pengusiran energi negatif melalui simbol-simbol raksasa yang diarak keliling desa. Ogoh-Ogoh dibuat dengan kreativitas tinggi, sering kali menggambarkan makhluk mitologis atau karakter kontemporer yang relevan dengan isu-isu sosial.",
      penjelasan:
        "Ogoh-Ogoh adalah patung raksasa yang diarak keliling desa pada malam sebelum Nyepi. Arak-arakan ini melibatkan masyarakat yang membawa Ogoh-Ogoh sambil diiringi gamelan dan teriakan semangat. Tujuan dari tradisi ini adalah untuk mengusir energi negatif dan membersihkan lingkungan sebelum memasuki hari Nyepi yang tenang dan damai.",
  ...
  return (
    <div className="bg-black text-white">
      ...
      {selectedGambar ? (
        <>
          <img className="h-[51.4rem] w-full opacity-20" src={selectedGambar.foto} />
          <div className="absolute top-0 w-[80%] h-full flex flex-col justify-center gap-4 pl-10 text-white">
            <h1 className="text-6xl font-bold">{selectedGambar.judul}</h1>
            <p className="text-lg">{selectedGambar.penjelasan}</p>
            <p className="text-lm">{selectedGambar.Sejarah}</p>
        ...
        <p className="text-center mt-20 text-2xl">Gambar tidak ditemukan</p>
      )}
    </div>
  );
}
