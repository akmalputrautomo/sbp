...
const Search = () => {
  ...
  return (
    <form className="relative flex items-center w-1/2 " onSubmit={handleSubmit}>
      <input placeholder="Apa yang ingin Kamu cari?" onChange={(e) => setSearch(e.target.value)} className=" bg-transparent outline outline-1 outline-red-500 pl-4 pr-10 py-2 rounded-full w-full text-white" type="text"></input>
